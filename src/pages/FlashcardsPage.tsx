  ...
  if (error || !deck) {
    return (
      <div style={{
        ...
        <div style={{ marginBottom: '16px', color: isDark ? '#6b7280' : '#9ca3af' }}><svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="4" y="2" width="14" height="18" rx="2" /><rect x="6" y="4" width="14" height="18" rx="2" /></svg></div>
        <p style={{
          fontSize: '16px',
